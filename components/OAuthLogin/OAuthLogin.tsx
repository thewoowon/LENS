      ...
      {isLoggedIn ? (
        ...
        <div className="py-[36px] w-[400px] flex flex-col items-center gap-[36px]">
          ...
          <ButtonBig
            ...
            className="m-2 flex justify-center items-center shadow-md gap-[16px] font-bold hover:bg-slate-100 border border-slate-200"
          >
            <div className="w-[36px] h-[36px] flex justify-center items-center">
              {loading ? (
                <div className="w-[24px] h-[24px] border-[2px] border-[#1e1e1e] border-dashed rounded-full animate-spin"></div>
              ) : (
                <svg
...
const Container = styled.main`
  ...
  box-shadow: 0 0 10px 0 rgba(256, 256, 256, 0.4);
  border-radius: 20px;
`;
