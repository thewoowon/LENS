  ...
  return (
    <div className="flex w-full h-full justify-center">
      {isLoggedIn ? (
        ...
        <div className="py-[36px] w-[400px] flex flex-col items-center">
          <div className="text-[24px] font-semibold">로그인이 필요합니다</div>
          <ButtonBig
            onClick={handleGoogle}
            className="m-2 flex justify-center items-center shadow-md text-black gap-[16px] font-bold hover:bg-slate-100 border border-slate-200"
          >
